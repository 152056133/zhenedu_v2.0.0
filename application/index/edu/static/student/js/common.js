$(function(){   
    ...
    $('.common_login .reg').click(function(){
        ...
        var user_name = $('.common_login .input5').val();
        var telephone = $('.common_login .input5').val();
        var code      = $('.common_login .input6').val();
        var pass_word = $('.common_login .input7').val();
        ...
        $.ajax({
            ...
            type:'POST',
            data:{user_name:user_name,telephone:telephone,code:code,pass_word:pass_word},
            //dataType:'json',
            error:function(e){
                layer.msg('网络错误');
            },
